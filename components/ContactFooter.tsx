        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-glim-blue flex items-center justify-center text-white hover:bg-white hover:text-glim-blue transition-all">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-glim-red flex items-center justify-center text-white hover:bg-white hover:text-glim-red transition-all">
                <Youtube className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-glim-purple flex items-center justify-center text-white hover:bg-white hover:text-glim-purple transition-all">
          ...
          <div>
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <button 
                type="submit" 
                className="w-full bg-glim-gold text-glim-dark font-bold py-3 rounded-lg hover:bg-white transition-colors"
              >
                Send Message
              </button>
            </form>
